...
interface IActionSheetPaymentMethodCicilan {
    disclosure: any
    data: any
...
const ActionSheetPaymentMethodCicilan: React.FC<IActionSheetPaymentMethodCicilan> = (props: IActionSheetPaymentMethodCicilan) => {
    const { 
        disclosure, 
        data, 
...
export default memo(ActionSheetPaymentMethodCicilan)